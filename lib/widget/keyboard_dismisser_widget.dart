...
/// Github: https://github.com/drogel/keyboard_dismisser
///
/// The gestures available to dismiss the keyboard with [KeyboardDismisserWidget].
///
...
/// that can absorb the gesture in it. For example, if a [KeyboardDismisserWidget]
...
///
/// Typical usage of [KeyboardDismisserWidget] involves wrapping a whole page with it,
...
/// [KeyboardDismisserWidget] will make the whole app acquire the behaviour from
/// [KeyboardDismisserWidget], since every [Scaffold] will be a child of the
...
class KeyboardDismisserWidget extends StatelessWidget {
  ...
  /// [KeyboardDismisserWidget] will dismiss the keyboard when performing a tapping
  /// gesture.
